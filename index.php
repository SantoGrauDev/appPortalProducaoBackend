...
// QUERY ESTOQUE
            ...
            $read = $conn->prepare("SELECT e.NOME_APELIDO as APELIDO, SUM(a.MECQUANTIDADE1) AS QTD, e.COR AS COR, e.MATFANTASIA AS MATFAN, f.MPVPRECOVENDA AS PRECO, e.ARMDESCRICAO AS MODELO, e.SUB_LINHA1 AS SUBLINHA1, e.SUB_LINHA2 AS GENERO "
                                    ...
                                    . "AND a.MECQUANTIDADE1 > '0'
                                       ...
                                       AND NOT b.NCMID = '71'
                                       AND NOT b.NCMID = '75'"
                                    . "GROUP BY e.NOME_APELIDO, e.COR, e.MATFANTASIA, f.MPVPRECOVENDA, e.ARMDESCRICAO, e.SUB_LINHA1, e.SUB_LINHA2  " 
                                    . "ORDER BY QTD desc ");
