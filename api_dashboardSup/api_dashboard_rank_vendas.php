...
$id = filter_input(INPUT_GET, 'id');
               ...
               $read = $conn->prepare("SELECT first 3 VENDEDOR AS VENDEDOR, SCORE AS SCORE, MEDIA_DE_VENDAS AS TM, c.MTVVALORMETA AS META, TOTAL_DE_VENDAS AS VENDAS
...
$array = $read->fetchAll();   
    ...
    foreach ($array as $dados): 
                   ...
                   $RankVendasPodium["RankVendasPodium"][] = [
    ...
    endforeach; 
                ...
                echo json_encode($RankVendasPodium);  
