...
$read = $conn->prepare("SELECT count(c.PESNOME) AS QTDTRANSACOES, sum(a.PEDVALORLIQUIDO) AS LIQUIDO, sum(a.PEDVALORLIQUIDO)/count(c.PESNOME) AS TM, a.PEDDATAENTRADA AS DATATM
                        ...
                        GROUP BY c.PESNOME,a.PEDDATAENTRADA
                        ");
               ...
               ['<?= date("d/m/Y",strtotime($dados["DATATM"]));?>', <?= $dados["TM"] ?> ],             
