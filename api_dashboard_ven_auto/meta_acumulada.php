...
// ************************************* QUERY RESPONSAVEL POR VERIFICAR META **********************************************

$id = filter_input(INPUT_GET, 'id');

               $read = $conn->prepare("SELECT c.MTVVALORMETA AS META
                                      FROM TB_NIVEL_ACESSO a
...
// ************************************* QUERY RESPONSAVEL POR VERIFICAR VENDA VENDEDOR **********************************************
$id = filter_input(INPUT_GET, 'id');
    ...
    foreach ($array as $dados): 
                  ...
                  $METADIA = $META/$days;
                   ...
                   $BoxVenda["BoxVenda"][] = [
                     ...
                     'DIFVENMETA' => number_format($DIFVENMETA,2,",","."),
